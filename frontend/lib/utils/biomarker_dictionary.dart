...
class BiomarkerDictionary {
  ...
  static const List<BiomarkerEntry> entries = [
    ...
    BiomarkerEntry(key: 'rdw_cv_pct', standardName: 'RDW-CV', unit: '%', referenceRange: '11.5 - 14.5', allowedUnits: ['%'], aliases: ['RDW', 'Red Cell Distribution Width'], description: 'A measure of the variation in size of red blood cells.'),
    BiomarkerEntry(key: 'rdw_sd_fl', standardName: 'RDW-SD', unit: 'fL', referenceRange: '39 - 46', allowedUnits: ['fL'], aliases: [], description: 'The actual measurement of the width of the red blood cell distribution curve.'),
    BiomarkerEntry(key: 'wbc_cells_ul', standardName: 'WBC', unit: 'cells/uL', referenceRange: '4000 - 11000', allowedUnits: ['cells/uL', '10^9/L'], aliases: ['White Blood Cell Count', 'TLC', 'Total Leucocyte Count', 'Total Leukocyte Count', 'Leucocyte Count'], description: 'The total number of white blood cells, which help the body fight infections.'),
    BiomarkerEntry(key: 'neutrophils_pct', standardName: 'Neutrophils', unit: '%', referenceRange: '40 - 60', allowedUnits: ['%'], aliases: ['Neutrophil', 'Neut', 'Segmented Neutrophils'], description: 'The most common type of white blood cell, primarily responsible for fighting bacterial infections.'),
    BiomarkerEntry(key: 'lymphocytes_pct', standardName: 'Lymphocytes', unit: '%', referenceRange: '20 - 40', allowedUnits: ['%'], aliases: ['Lymphocyte', 'Lymph'], description: 'White blood cells that are key to the immune system, including T cells and B cells.'),
    BiomarkerEntry(key: 'eosinophils_pct', standardName: 'Eosinophils', unit: '%', referenceRange: '1 - 4', allowedUnits: ['%'], aliases: ['Eosinophil', 'Eosino', 'Eos'], description: 'White blood cells active during allergic reactions and parasitic infections.'),
    BiomarkerEntry(key: 'monocytes_pct', standardName: 'Monocytes', unit: '%', referenceRange: '2 - 8', allowedUnits: ['%'], aliases: ['Monocyte', 'Mono'], description: 'White blood cells that migrate to tissues and become macrophages to consume pathogens.'),
    BiomarkerEntry(key: 'basophils_pct', standardName: 'Basophils', unit: '%', referenceRange: '0.5 - 1', allowedUnits: ['%'], aliases: ['Basophil', 'Baso'], description: 'The least common white blood cell, involved in inflammatory and allergic responses.'),
    BiomarkerEntry(key: 'abs_neutrophils', standardName: 'Abs. Neutrophils', unit: 'cells/uL', referenceRange: '1500 - 8000', allowedUnits: ['cells/uL', '10^9/L'], aliases: ['ANC', 'Absolute Neutrophil Count'], description: 'The actual number of neutrophils present in the blood.'),
    BiomarkerEntry(key: 'abs_lymphocytes', standardName: 'Abs. Lymphocytes', unit: 'cells/uL', referenceRange: '1000 - 4800', allowedUnits: ['cells/uL', '10^9/L'], aliases: ['ALC', 'Absolute Lymphocyte Count'], description: 'The actual number of lymphocytes present in the blood.'),
    BiomarkerEntry(key: 'abs_monocytes', standardName: 'Abs. Monocytes', unit: 'cells/uL', referenceRange: '200 - 1000', allowedUnits: ['cells/uL', '10^9/L'], aliases: ['Absolute Monocyte Count'], description: 'The actual number of monocytes present in the blood.'),
    BiomarkerEntry(key: 'abs_eosinophils', standardName: 'Abs. Eosinophils', unit: 'cells/uL', referenceRange: '0 - 500', allowedUnits: ['cells/uL', '10^9/L'], aliases: ['AEC', 'Absolute Eosinophil Count'], description: 'The actual number of eosinophils present in the blood.'),
    BiomarkerEntry(key: 'abs_basophils', standardName: 'Abs. Basophils', unit: 'cells/uL', referenceRange: '0 - 200', allowedUnits: ['cells/uL', '10^9/L'], aliases: ['Absolute Basophil Count'], description: 'The actual number of basophils present in the blood.'),

    // ─── Platelet ─────────────────────────────────────────
    BiomarkerEntry(key: 'platelet_count_x10_3_ul', standardName: 'Platelet Count', unit: 'x10³/uL', referenceRange: '150 - 450', allowedUnits: ['x10³/uL', '10^9/L'], aliases: ['PLT', 'Platelets', 'Thrombocyte Count'], description: 'Cells that help the blood clot to stop bleeding.'),
    BiomarkerEntry(key: 'mpv_fl', standardName: 'MPV', unit: 'fL', referenceRange: '7.5 - 11.5', allowedUnits: ['fL'], aliases: ['Mean Platelet Volume'], description: 'The average size of the platelets in your blood.'),
    BiomarkerEntry(key: 'platelet_rdw_pct', standardName: 'Platelet RDW', unit: '%', referenceRange: '9 - 17', allowedUnits: ['%'], aliases: ['PDW', 'Platelet Distribution Width'], description: 'Measurement of how much platelets vary in size.'),
    BiomarkerEntry(key: 'pct_pct', standardName: 'PCT', unit: '%', referenceRange: '0.17 - 0.35', allowedUnits: ['%'], aliases: ['Plateletcrit'], description: 'The volume occupied by platelets in the blood.'),
    BiomarkerEntry(key: 'p_lcr_pct', standardName: 'P-LCR', unit: '%', referenceRange: '13 - 43', allowedUnits: ['%'], aliases: ['Platelet Large Cell Ratio'], description: 'The percentage of large-sized platelets.'),
    BiomarkerEntry(key: 'img_pct', standardName: 'IMG', unit: '%', referenceRange: '0 - 0.5', allowedUnits: ['%'], aliases: [], description: 'Immature Granulocyte percentage.'),
    BiomarkerEntry(key: 'imm_pct', standardName: 'IMM', unit: '%', referenceRange: '0 - 0.5', allowedUnits: ['%'], aliases: [], description: 'Immature Monocyte percentage.'),
    BiomarkerEntry(key: 'iml_pct', standardName: 'IML', unit: '%', referenceRange: '0 - 0.5', allowedUnits: ['%'], aliases: [], description: 'Immature Lymphocyte percentage.'),
    BiomarkerEntry(key: 'lic_pct', standardName: 'LIC', unit: '%', referenceRange: '0 - 2.5', allowedUnits: ['%'], aliases: [], description: 'Large Immature Cell percentage.'),
    ...
    // ─── Liver Function ───────────────────────────────────
    BiomarkerEntry(key: 'bilirubin_total_mg_dl', standardName: 'Bilirubin Total', unit: 'mg/dL', referenceRange: '0.1 - 1.2', allowedUnits: ['mg/dL', 'umol/L', 'µmol/L'], aliases: ['Total Bilirubin', 'T. Bilirubin', 'S. Bilirubin'], description: 'A yellow pigment produced during the normal breakdown of red blood cells.'),
    BiomarkerEntry(key: 'bilirubin_direct_mg_dl', standardName: 'Bilirubin Direct', unit: 'mg/dL', referenceRange: '< 0.3', allowedUnits: ['mg/dL', 'umol/L', 'µmol/L'], aliases: ['Direct Bilirubin', 'Conjugated Bilirubin'], description: 'Bilirubin that has been processed by the liver and is ready for excretion.'),
    BiomarkerEntry(key: 'bilirubin_indirect_mg_dl', standardName: 'Bilirubin Indirect', unit: 'mg/dL', referenceRange: '0.1 - 1.0', allowedUnits: ['mg/dL', 'umol/L', 'µmol/L'], aliases: ['Indirect Bilirubin', 'Unconjugated Bilirubin'], description: 'Bilirubin that has not yet been processed by the liver.'),
    BiomarkerEntry(key: 'alp_u_l', standardName: 'ALP', unit: 'U/L', referenceRange: '44 - 147', allowedUnits: ['U/L', 'µkat/L'], aliases: ['Alkaline Phosphatase', 'Alk. Phosphatase'], description: 'An enzyme found in the liver, bones, kidneys, and digestive system.'),
    BiomarkerEntry(key: 'alt_sgpt_u_l', standardName: 'ALT (SGPT)', unit: 'U/L', referenceRange: '7 - 56', allowedUnits: ['U/L', 'µkat/L'], aliases: ['ALT', 'SGPT', 'Alanine Aminotransferase', 'Alanine Transaminase'], description: 'An enzyme found mostly in the liver; high levels suggest liver damage.'),
    BiomarkerEntry(key: 'ast_sgot_u_l', standardName: 'AST (SGOT)', unit: 'U/L', referenceRange: '8 - 48', allowedUnits: ['U/L', 'µkat/L'], aliases: ['AST', 'SGOT', 'Aspartate Aminotransferase', 'Aspartate Transaminase'], description: 'An enzyme found in the liver, heart, and muscles.'),
    BiomarkerEntry(key: 'ggt_u_l', standardName: 'GGT', unit: 'U/L', referenceRange: '9 - 48', allowedUnits: ['U/L', 'µkat/L'], aliases: ['Gamma GT', 'Gamma Glutamyl Transferase', 'Gamma-Glutamyl Transpeptidase'], description: 'An enzyme found in the liver and bile ducts; sensitive to alcohol and bile duct issues.'),
    BiomarkerEntry(key: 'protein_total_g_dl', standardName: 'Total Protein', unit: 'g/dL', referenceRange: '6.0 - 8.3', allowedUnits: ['g/dL', 'g/L'], aliases: ['Protein Total', 'S. Protein', 'Serum Protein', 'Total Proteins'], description: 'The total amount of albumin and globulin in the blood.'),
    BiomarkerEntry(key: 'albumin_g_dl', standardName: 'Albumin', unit: 'g/dL', referenceRange: '3.4 - 5.4', allowedUnits: ['g/dL', 'g/L'], aliases: ['S. Albumin', 'Serum Albumin', 'Alb'], description: 'A protein made by the liver that keeps fluid from leaking out of blood vessels.'),
    BiomarkerEntry(key: 'globulin_g_dl', standardName: 'Globulin', unit: 'g/dL', referenceRange: '2.0 - 3.5', allowedUnits: ['g/dL', 'g/L'], aliases: ['S. Globulin', 'Serum Globulin'], description: 'A group of proteins in the blood that help the immune system and liver function.'),
    ...
    // ─── HbA1c ────────────────────────────────────────────
    BiomarkerEntry(key: 'hba1c_pct', standardName: 'HbA1c', unit: '%', referenceRange: '< 5.7', allowedUnits: ['%', 'mmol/mol'], aliases: ['Glycated Hemoglobin', 'Glycosylated Hemoglobin', 'A1C', 'Glycated Haemoglobin'], description: 'Measures average blood sugar levels over the past 2-3 months.'),
    BiomarkerEntry(key: 'estimated_avg_glucose_mg_dl', standardName: 'Estimated Avg. Glucose', unit: 'mg/dL', referenceRange: '< 117', allowedUnits: ['mg/dL', 'mmol/L'], aliases: ['eAG', 'Estimated Average Glucose'], description: 'A calculated average of blood glucose based on HbA1c results.'),
    BiomarkerEntry(key: 'hbf_pct', standardName: 'HbF', unit: '%', referenceRange: '< 2.0', allowedUnits: ['%'], aliases: ['Fetal Hemoglobin'], description: 'A form of hemoglobin that is normal in infants but low in adults.'),
    ...
    BiomarkerEntry(key: 'phosphorus_mg_dl', standardName: 'Phosphorus', unit: 'mg/dL', referenceRange: '2.5 - 4.5', allowedUnits: ['mg/dL', 'mmol/L'], aliases: ['Phosphate', 'Phos', 'S. Phosphorus', 'Inorganic Phosphorus'], description: 'A mineral that works with calcium to build bones and teeth.'),

    // ─── Thyroid Profile ──────────────────────────────────
    BiomarkerEntry(key: 'tt3_ng_dl', standardName: 'Total T3', unit: 'ng/dL', referenceRange: '80 - 200', allowedUnits: ['ng/dL', 'nmol/L'], aliases: ['T3', 'TT3', 'Triiodothyronine'], description: 'One of the two main hormones produced by the thyroid gland.'),
    BiomarkerEntry(key: 'tt4_ug_dl', standardName: 'Total T4', unit: 'ug/dL', referenceRange: '5.0 - 12.0', allowedUnits: ['ug/dL', 'nmol/L'], aliases: ['T4', 'TT4', 'Thyroxine'], description: 'The main hormone produced by the thyroid gland.'),
    BiomarkerEntry(key: 'tsh_uiu_ml', standardName: 'TSH', unit: 'uIU/mL', referenceRange: '0.4 - 4.0', allowedUnits: ['uIU/mL', 'mIU/L'], aliases: ['Thyroid Stimulating Hormone', 'Thyrotropin'], description: 'Hormone from the pituitary gland that tells the thyroid to make T3 and T4.'),

    // ─── Glucose ──────────────────────────────────────────
    BiomarkerEntry(key: 'fasting_glucose_mg_dl', standardName: 'Fasting Glucose', unit: 'mg/dL', referenceRange: '70 - 99', allowedUnits: ['mg/dL', 'mmol/L'], aliases: ['FBS', 'Fasting Blood Sugar', 'Fasting Blood Glucose', 'Glucose Fasting', 'F. Glucose'], description: 'Blood sugar level measured after an 8-12 hour fast.'),
    BiomarkerEntry(key: 'postprandial_glucose_mg_dl', standardName: 'Postprandial Glucose', unit: 'mg/dL', referenceRange: '< 140', allowedUnits: ['mg/dL', 'mmol/L'], aliases: ['PPBS', 'PP Blood Sugar', 'PP Glucose', 'Post Prandial Blood Sugar', 'Glucose PP'], description: 'Blood sugar level measured 2 hours after a meal.'),
    BiomarkerEntry(key: 'fbs_mg_dl', standardName: 'FBS', unit: 'mg/dL', referenceRange: '70 - 99', allowedUnits: ['mg/dL', 'mmol/L'], aliases: ['Fasting Blood Sugar'], description: 'Fasting Blood Sugar (Diagnostic specific).'),
    BiomarkerEntry(key: 'plbs_mg_dl', standardName: 'PLBS', unit: 'mg/dL', referenceRange: '< 140', allowedUnits: ['mg/dL', 'mmol/L'], aliases: ['Post Lunch Blood Sugar'], description: 'Post Lunch Blood Sugar (Diagnostic specific).'),

    // ─── Urinalysis ───────────────────────────────────────
    BiomarkerEntry(key: 'urine_colour', standardName: 'Urine Colour', unit: '', referenceRange: 'Pale yellow to amber', aliases: ['Urine Color', 'Colour'], description: 'The visual color of the urine sample.'),
