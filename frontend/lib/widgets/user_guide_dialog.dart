                ...
                child: PageView(
                  ...
                  children: [
                    _buildPage(
                      ...
                      description: 'Capture or upload reports from your gallery. MedScan\'s advanced scanning pipeline automatically optimizes the image details:',
                      bullets: [
                        'Positioning: Keep your reports flat, vertical, and in clear lighting.',
                        'Uneven Shadows: Automatically filtered out by dividing out uneven contrast.',
                        'Content-Aware Splitting: Automatically trims white spaces at row gaps, maximizing OCR readability.',
                        'Multi-Page Auto-Merge: Seamlessly groups multi-sheet scans into a single history log.',
                      ],
                    ...
                    _buildPage(
                      ...
                      description: 'Verify critical values extracted by our OCR engine before saving to your profile:',
                      bullets: [
                        'Ref ID / Specimen No: Verify identifiers like Lab Numbers or Accession codes.',
                        '24h Time Standardization: Automatically converts local formats (e.g. 3 PM) to a clean, clinical 24h timeline.',
                        'Smart Correction: Tap any field, value, or unit to edit and make updates instantly.',
                      ],
                    ...
                    _buildPage(
                      ...
                      description: 'Get an instant, readable overview of your biomarker reports at the top of your dashboard:',
                      bullets: [
                        'Empathetic Insights: Reads your markers to flag out-of-range anomalies.',
                        'Physiological Links: Shows how separate abnormal tests connect.',
                        'Quick Deep Dive: Use the direct assistant link on the dashboard to chat instantly about your report summary.',
                      ],
                    ...
                    _buildPage(
                      ...
                      description: 'Observe physiological changes dynamically using dashboard graphing tools:',
                      bullets: [
                        'Multi-Attribute Overlays: Plot multiple items (e.g. HDL vs LDL) together.',
                        'Global Filtering: Adjust the dashboard timeline to focus on specific dates.',
                        'Collapsible Categories: Biomarkers are cleanly structured across 14 medical profiles (Lipids, Liver, Kidney, CBC, etc.).',
                      ],
                    ...
                    _buildPage(
                      ...
                      description: 'Prevent duplicate entries from cluttering your historical record:',
                      bullets: [
                        'Identifier Match: Rejects identical Specimen IDs or Accession Numbers.',
                        'Clinical Fingerprinting: Identifies and flags reports that share >= 90% identical values.',
                        'Fuzzy Validation: Performs overlap checking (+/- 2 days verification window).',
                      ],
                    ...
                    _buildPage(
                      ...
                      description: 'Interact with our private chatbot designed to explain clinical terms in simple language:',
                      bullets: [
                        'Personalized Scope: The AI understands your entire uploaded history automatically.',
                        'Actionable Tips: Ask for tailored wellness guidance, dietary recommendations, or trend explanations.',
                        'Interactive Chat: Try asking "What does a high LDL mean?" or "Explain my creatinine results."',
                      ],
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Your Lipid panel is high but Kidney metrics show normal filtration values.',
                  style: TextStyle(
                    fontSize: 11,
                    height: 1.35,
